...
object Clear extends AdminAction {
    ...
    override def run(request: Request[AnyContent]) {
        ...
        models.Region.getOrCreate("Albania", Option("Albanian"), isInternational = false)
        models.Region.getOrCreate("Algeria", Option("Algerian"), isInternational = false)
        models.Region.getOrCreate("Andorra", Option("Andorran"), isInternational = false)
        models.Region.getOrCreate("Angola", Option("Angolan"), isInternational = false)
        models.Region.getOrCreate("Antigua and Barbuda", None, isInternational = false)
        models.Region.getOrCreate("Argentina", Option("Argentine"), isInternational = false)
        ...
        models.Region.getOrCreate("Austria", Option("Austrian"), isInternational = false)
        ...
        models.Region.getOrCreate("Bulgaria", Option("Bulgarian"), isInternational = false)
        ...
        models.Region.getOrCreate("Cambodia", Option("Cambodian"), isInternational = false)
        ...
        models.Region.getOrCreate("Chile", Option("Chilean"), isInternational = false)
        ...
        models.Region.getOrCreate("Comoros", Option("Comorian"), isInternational = false)
        ...
        models.Region.getOrCreate("Denmark", Option("Danish"), isInternational = false)
        ...
        models.Region.getOrCreate("El Salvador", Option("Salvadoran"), isInternational = false)
        ...
        models.Region.getOrCreate("Estonia", Option("Estonian"), isInternational = false)
        models.Region.getOrCreate("Ethiopia", Option("Ethiopian"), isInternational = false)
        models.Region.getOrCreate("Fiji", Option("Fijian"), isInternational = false)
        models.Region.getOrCreate("Finland", Option("Finnish"), isInternational = false)
        ...
        models.Region.getOrCreate("Gambia", Option("Gambian"), isInternational = false)
        models.Region.getOrCreate("Georgia", Option("Georgian"), isInternational = false)
        ...
        models.Region.getOrCreate("Guatemala", Option("Guatemalan"), isInternational = false)
        models.Region.getOrCreate("Guinea", Option("Guinean"), isInternational = false)
        models.Region.getOrCreate("Guinea-Bissau", Option("Guinean"), isInternational = false)
        models.Region.getOrCreate("Guyana", None, isInternational = false)
        models.Region.getOrCreate("Haiti", Option("Haitian"), isInternational = false)
        models.Region.getOrCreate("Honduras", None, isInternational = false)
        models.Region.getOrCreate("Hungary", Option("Hungarian"), isInternational = false)
        ...
        models.Region.getOrCreate("Iran", Option("Iranian"), isInternational = false)
        models.Region.getOrCreate("Iraq", Option("Iraqi"), isInternational = false)
        models.Region.getOrCreate("Ireland", Option("Irish"), isInternational = false)
        models.Region.getOrCreate("Israel", Option("Israeli"), isInternational = false)
        ...
        models.Region.getOrCreate("Mexico", Option("Mexican"), isInternational = false)
        ...
        models.Region.getOrCreate("Norway", Option("Norwegian"), isInternational = false)
        ...
        models.Region.getOrCreate("Portugal", Option("Portuguese"), isInternational = false)
        models.Region.getOrCreate("Qatar", None, isInternational = false)
        models.Region.getOrCreate("Romania", Option("Romanian"), isInternational = false)
        ...
        models.Region.getOrCreate("Somalia", Option("Somalian"), isInternational = false)
        models.Region.getOrCreate("South Africa", None, isInternational = false)
        models.Region.getOrCreate("Spain", Option("Spanish"), isInternational = false)
        ...
        models.Region.getOrCreate("Sweden", Option("Swedish"), isInternational = false)
        ...
        models.Region.getOrCreate("Tunisia", Option("Tunisian"), isInternational = false)
        models.Region.getOrCreate("Turkey", Option("Turkish"), isInternational = false)
        ...
        models.Region.getOrCreate("United States", None, isInternational = false)
